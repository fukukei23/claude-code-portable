...
STATE      = Path("/home/__USERNAME__/.claude/scripts/auto-dev/state.json")
LOG        = Path("/home/__USERNAME__/.claude/scripts/auto-dev/loop.log")
RUN_SCRIPT = Path("/home/__USERNAME__/.claude/scripts/auto-dev/run-issue.sh")
NOTIFY     = Path("/home/__USERNAME__/.claude/scripts/hooks/notify-done.sh")
...
def main() -> None:
    ...
    repo_path = state.get("repo_path", "/home/__USERNAME__/projects/atelier-kyo-manager")
