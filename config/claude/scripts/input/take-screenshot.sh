...
OUTPUT_PATH="${1:-/home/__USERNAME__/screenshot.png}"
SCRIPT_PATH="/home/__USERNAME__/.claude/scripts/take-screenshot.ps1"

# Convert WSL path to Windows path for PowerShell
if [[ "$OUTPUT_PATH" == /home/* ]]; then
    WIN_PATH=$(echo "$OUTPUT_PATH" | sed 's|/home/__USERNAME__|\\\\wsl.localhost\\Ubuntu\\home\\__USERNAME__11|')
else
