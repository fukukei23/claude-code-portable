...
# Example: ./monitor-screen.sh 60 /home/__USERNAME__/screenshots

INTERVAL="${1:-60}"
OUTPUT_DIR="${2:-/home/__USERNAME__/screenshots}"
TAKE_SS="/home/__USERNAME__/.claude/scripts/take-screenshot.sh"
