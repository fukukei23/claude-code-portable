...
SETTINGS_WSL="/home/__USERNAME__/.claude/settings.json"
EXAMPLE_WSL="/home/__USERNAME__/projects/claude-config/settings.example.json"
...
src = "/home/__USERNAME__/.claude/settings.json"
dst = "/home/__USERNAME__/projects/claude-config/settings.example.json"
